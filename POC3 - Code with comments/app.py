...
def generate_comments(code_chunk):
    prompt = """
        ...
        Response should contain code as it is and comment explaining code logic
        The code chunk is as follows:
        ```rpg
    """ + code_chunk + """
        ```
        Briefly explain the logic of this code. Structure of response will explanation of enitre code logic. Then code line followed by comment explaining each code line.
        """
